...
import { Link } from "react-router-dom"; // Importing the Link component from react-router-dom libraryimport { Link } from "react-router-dom"; // Importing the Link component from react-router-dom library
import "./Navbar.css";

const Navbar = () => {
  // Function to handle the nav icon click
  const handleClick = () => {
